...
function DropdownNavItem({ headingText, logoSrc, altText, logoProps, children }) {
    const [isOpen, setIsOpen] = useState(false);
    const toggleVisibility = () => {
        setIsOpen(prevState => !prevState)
    }
    return(
        <div className="nav-item nav-dropdown" onClick={toggleVisibility}>
            ...
            <a className="nav-heading">{ headingText }</a>
...
const toggleNavDropdown = () => {
    ...
    for (let i = 0; i < headingsToBeToggled.length; i++) {
        ...
        heading.addEventListener("click", (e) => {
            ...
            if (e.target) console.log(`[toggleNavDropdown]: clicked ${e.target}`)
            else console.log(`[toggleNavDropdown]: called ${e}`)
        ...
        <div className="menu shadow-off">
            ...
            <div className="nav-items-container">
                ...
                <div className="nav-item not-dropdown">
                    ...
                    <Link href='/' className="nav-heading">Home</Link>
                </div>
                ...
                <div className="nav-item not-dropdown">
                    ...
                    <Link href='/about' className="nav-heading">About Us</Link>
                </div>
          
                <DropdownNavItem headingText="Rehab Services" logoSrc={RehabilitationLogo} altText="rehabilitation healing logo">
                    <Link href='/rehab/early-intervention'>Early Intervention</Link>
                    <Link href="/rehab/speech">Speech Pathology</Link>
                    <Link href='/rehab/prevocational'>Pre Vocational</Link>
                    <Link href='/rehab/special-education'>Special Education</Link>
                ...
                <DropdownNavItem headingText="NIOS" logoSrc={NiosLogo} altText="Logo of NIOS" logoProps={{id: "nios-logo"}}>
                    <Link href="/nios/admin-services">Admin Services</Link>
                        <Link href="/nios/academic-services">Academic Services</Link>
                        <Link href="/nios/study-center">Study Center</Link>
                </DropdownNavItem>
